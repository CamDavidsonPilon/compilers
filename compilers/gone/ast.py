...
class AST(object):
    ...
    def __repr__(self):
        # if would be nice if this could print more things, like usage
...
class UnaryOp(Expression):
    '''
    A Unary operator such as +2 or -1
    '''
    op    : str
    right  : Expression
...
class IfConditional(Statement):
    ...
    '''
    switch     : Expression
    true_path  : Statements
    false_path : (Statements, type(None))


class WhileConditional(Statement):
    '''
